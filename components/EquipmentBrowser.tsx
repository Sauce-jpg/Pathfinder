...
const CATEGORIES = [
  ...
  { id: "magic-weapons", name: "Magic Weapons", count: 323, icon: "✨⚔️" },
  ...
  { id: "magic-armor", name: "Magic Armor", count: 131, icon: "✨🛡️" },
  ...
  { id: "shields", name: "Shields", count: 15, icon: "🔰" },
  { id: "magic-shields", name: "Magic Shields", count: 50, icon: "✨🔰" },
